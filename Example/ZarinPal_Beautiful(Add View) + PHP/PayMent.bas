...
Sub Activity_Create(FirstTime As Boolean)
	AH_ZarinPal_Beautiful1.Initialize(Me,"AH_ZarinPal_Beautiful1")'x برای متغیر اولی حتما همین باشه و برای متغیر دومی اونت نیم دلخواهتون رو بزنید که بعد از پرداخت با اون اونت سابتون اجرا بشه
